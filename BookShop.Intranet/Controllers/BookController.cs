...
namespace BookShop.Intranet.Controllers
{
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Description,IsActive,Quantity,ImageNameUrl,Price,DateAdded")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Description,IsActive,Quantity,ImageNameUrl,Price,DateAdded")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
